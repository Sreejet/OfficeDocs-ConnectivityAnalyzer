...
|---|---|
| [Skype for Business Server Remote Connectivity Test](https://testconnectivity.microsoft.com/tests/OnPremisesSfB/input)	| This test verifies your remote connectivity to the Microsoft Skype for Business Server. |
| [Skype for Business ](https://testconnectivity.microsoft.com/tests/OnPremisesSfBMobileAutoD/input)	| This test verifies the remote connectivity for mobile devices and the Skype for Business Windows Store app to your on-premises Skype for Business Autodiscover web service server by establishing a secure HTTPS connection for the root token. |
