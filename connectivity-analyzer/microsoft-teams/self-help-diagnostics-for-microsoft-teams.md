...
| [Teams Shared Channel Add Member](https://testconnectivity.microsoft.com/tests/TeamsExternalCollab/input) | This test verifies if a user can be added to a Shared Channel, including Share a channel with People and Collaborate with external participants in a channel. |
